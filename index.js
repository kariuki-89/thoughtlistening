...
const websocket = new WebSocket("ws://localhost:8000/ws");
        ...
        websocket.onmessage = function(event) {
            ...
            if (data.type === "action") {
              let cdnData2={
                uuid: messageId,
                message: `Action: ${data.tool}, Input: ${data.tool_input}`,
                agent:theAgentId,
                agent_type:"received",
                creator: theUniqueId2,
                accessToken:theKey2,
              ...
              cdn_createAgent("messages",cdnData2);
                ...
                console.log(`Action: ${data.tool}, Input: ${data.tool_input}`)
              ...
              cdn_createAgent("messages",cdnData2);
              displayThought(data.inputs, data.chain);
                ...
                //answer.textContent = `Final Answer: ${data.output}`;
                //updatesDiv.appendChild(answer);
                console.log(`Final Answer: ${data.output}`)
            }
        };
